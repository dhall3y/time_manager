                ...
                <div v-else class="p-6 space-y-4 md:space-y-6 sm:p-8" tabindex="0" aria-label="Sign in to your account">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        <div>
                            ...
                            <input v-model="username" id="username" type="text" name="usernameForm" class="bg-tertiary text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="username">
                        </div>
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-second-text">Your email</label>
                            <input v-model="email" type="email" name="email" id="email" class="bg-tertiary text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="name@company.com" required="" aria-label="enter your email">
